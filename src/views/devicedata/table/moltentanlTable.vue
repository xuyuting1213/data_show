<template>
  <div>
    ...
    <div class="table-container" :style="{ height: heightValue }">
          ...
          <template #default="scope">
            <div v-if="!scope.row.editing">
              ...
              >
                ...
                <span v-else>
                  <span v-if="column.prop == '罐体设备类别'">
                    {{ formatShowData(scope.row[column.prop], "tankType") }}
                  </span>
                  <span v-else>
      ...
      <el-button
        type="primary"
        @click="$downloadExcel({ tableData: tabledata, title: '熔融金属罐体' })"
        class="plusicon"
        size="small"
        >导出数据</el-button
      >
...
export default {
  props: ["column", "tabledata", "operate", "tankType"],
