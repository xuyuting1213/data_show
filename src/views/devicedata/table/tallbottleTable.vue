<template>
  <div>
    ...
    <div class="table-container">
      ...
      <el-button
        type="primary"
        @click="$downloadExcel({ tableData: tabledata, title: '高炉' })"
        class="plusicon"
        size="small"
        >导出数据</el-button
      >
      ...
      <div class="dialog-content">
        ...
        >
          ...
          >
            ...
            <div
              v-if="
                column.prop == '检验报告上传' || column.prop == '停用/报废证明'
              "
            >
              <Uploadocom
...
export default {
  ...
  methods: {
    ...
    cancelImg(column) {
      this.$emit("deleteImage", this.newRow[column]);
