    ...
    <div>
      ...
      <div class="table-container">
        <el-table
          ...
          :height="!showsearch ? 'calc(100vh - 3.2rem)' : 'calc(100vh - 3.8rem)'"
          v-loading="loading"
          :key="showSelect"
            ...
            <template #default="scope">
              <div v-if="!scope.row.editing">
                ...
                >
                  <span
                    v-if="
                      column.prop.indexOf('日期') >= 0 && scope.row[column.prop]
                    "
                    >{{ scope.row[column.prop].replace("T00:00:00", "") }}</span
                  >
                  <span v-else>
                    <span v-if="column.prop == '位置类型'">
                      {{ formatShowData(scope.row[column.prop],"position_type") }}
                    </span>
      ...
      >
        <div class="dialog-content">
          ...
          >
            <el-form-item
              ...
              :key="column.prop"
              :label="column.prop != '位置类型' ? column.label : '位置类型编码'"
              :prop="column.label"
              v-if="
                column.label != '系统ID' &&
                column.label != 'ID' &&
            ...
            >
              ...
              <el-select
                ...
                style="width: 8rem"
                :disabled="
                  check_datas.indexOf(column.prop) >= 0 && operatetitle == '编辑'
                "
              >
                <el-option
              ...
              >
                <Uploadocom
                  v-if="
                    newRow[column.prop] === '' &&
                    !(
                      check_datas.indexOf(column.prop) >= 0 &&
                      operatetitle == '编辑'
                    )
                  "
                ...
                <div style="width: 1rem" v-else>
                  ...
                  <div style="width: 1rem">
                    <span
                      v-if="!newRow[column.prop] || operatetitle == '添加'"
              ...
              <el-input
                ...
                style="width: 8rem"
              ></el-input>
              <!-- <div v-if="column.prop == '位置类型'"> -->
              <!-- 请根据位置类型文档严格填写：<el-button
                  type="text"
                  size="mini"
                  @click="tabledialog = true"
                  >点击查看位置类型编码</el-button
                >
              </div> -->
              <div
        ...
        <el-dialog
          ...
          width="9.5rem"
        >
          <img src="../../../assets/images/codeco.jpg" style="width: 9rem" />
        </el-dialog>
      </el-dialog>
  ...
  export default {
    ...
    data() {
      return {
        ...
        tabledialog: false,
        position_type: [
          { label: "会议室", value: "1001" },
          { label: "活动室", value: "1002" },
          { label: "休息室", value: "1003" },
          { label: "操作室", value: "1004" },
          { label: "化验室", value: "1005" },
          { label: "交接班室", value: "1006" },
          { label: "更衣室", value: "1007" },
          {
            label:
              "焦炉地下室，加热炉地下室、退火炉地下室、煤气柜进出口管道地下室",
            value: "2001",
          },
          { label: "加压机房", value: "2002" },
          { label: "烘烤器", value: "2003" },
          { label: "预热器", value: "2004" },
          {
            label: "高炉风口及以上各层平台（炉顶大方孔以上各层平台除外）",
            value: "2005",
          },
          { label: "高炉炉身平台", value: "2006" },
          { label: "高炉炉顶液压站", value: "2007" },
          { label: "高炉炉顶封闭式油泵间", value: "2008" },
          { label: "高炉炉顶封闭式工具间", value: "2009" },
          { label: "热风炉煤气自动切断阀操作平台", value: "2010" },
          { label: "喷煤干燥炉", value: "2011" },
          { label: "煤粉制备间", value: "2012" },
          { label: "煤气发电设施间（含 TRT 透平机隔音罩）", value: "2013" },
          { label: "煤气除尘器卸灰平台", value: "2014" },
          { label: "转炉炉口以上各层平台", value: "2015" },
          { label: "抽气机房", value: "2016" },
          { label: "煤气加热炉炉区", value: "2017" },
          { label: "煤气热处理炉炉区", value: "2018" },
          { label: "煤气柜活塞上部", value: "2019" },
          { label: "烧结球团主抽风机室", value: "2020" },
          { label: "烧结点火炉附近", value: "2021" },
          { label: "球团竖炉点火器附近", value: "2022" },
          { label: "球团回转窑点火器附近", value: "2023" },
          { label: "排水器房", value: "2024" },
          { label: "煤气预热炉炉区", value: "2025" },
          { label: "真空精炼装置的水封池", value: "2026" },
          { label: "机械真空泵房", value: "2027" },
          { label: "无", value: "无" },
        ],
      };
    },
     ...
     formatShowData(row, name) {
        ...
        this.$functionConfrim(this.showSelectvalue).then((result) => {
          ...
          if (result.status == "yes") {
            this.$emit("reportInfo", {
              checkevalue: JSON.parse(JSON.stringify(this.showSelectvalue)),
      ...
      editRow(row) {
        ...
        this.$nextTick(() => {
          ...
          this.rules_data = this.$formatFormRules(["量程PPM"], this.newRow,{});
        });
