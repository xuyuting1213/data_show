<template>
    <div style="width: 100%; height: 100%">
      <div class="loadgif" v-if="loading" style="top: -10%">
        <img src="../../../assets/images/loading.gif" id="show_loading" /><span
          style="color: white"
          >摄像头数据获取中</span
        >
      </div>
            ...
            <el-col>
              <el-form-item>
                <el-button
                  icon="el-icon-view"
                  size="mini"
                  @click="clickStartRealPlay(undefined, hasLogin)"
                  type="primary"
                  >播放</el-button
                >
                <!-- <el-button
  ...
  export default {
          ...
          this.passWord,
          {
            ...
            error: function (err) {
              ...
              if (err.errorCode == 2001) {
                ...
                that.$message.error("设备登录失败，请刷新页面重新登录！");
                // that.hasLogin = false;
              }
              that.loading = false;
            },
    ...
    beforeDestroy() {
      ...
      // console.log("hkVideo before destroy...");
      //   console.log('nnnnnnnn',document.querySelector('#divABC01'))
      //   console.log('nnnnnnnn',document.querySelector('#divABC02'))
    ...
    destroyed() {
      setTimeout(() => {
        // this.breakDom();
        // console.log(document.querySelector('#divABC01'))
      }, 100);
    },
  };
  </script>
